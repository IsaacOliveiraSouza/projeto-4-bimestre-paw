...
app.get('/loginUsuario', function(req,res){
    ...
    conn.query(sql, function(error, result){
       ...
       console.log(nome_usu)
        ...
        console.log("novo usuario: "+ id_usu)
    })
})
...
app.get("/enviarMsg", function(req,res){
    ...
    msg = msg.replace(/merda/g, "*").replace(/porra/g, "*").replace(/bosta/g, "*").replace(/filha da puta/g, " *").replace(/arrombado/g, "*").replace(/puta/g, "*").replace(/buceta/g, "*")
